...
\end{figure}
	...
	\section{Wnioski}
	Parametr alfa ma wpływ na obszary krytyczne.
	Symulacje potwierdziły teoretyczną poprawność testów statystycznych. Empiryczny błąd I rodzaju jest zgodny z założonym poziomem $\alpha$. Moc testu rośnie wraz z odległością między parametrem rzeczywistym a z hipotezy. 
